...
const renderJsData = (data, searchTerm) => {
...
const onSubmit = (event) => {
	...
	loadJsData("./data.json").then((data) => renderJsData(data, searchTerm));
};

loadJsData("./data.json").then((data) => renderJsData(data));
